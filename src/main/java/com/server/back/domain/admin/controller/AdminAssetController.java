...
public class AdminAssetController {
    ...
    public ResponseEntity<ResultDto<List<AdminAssetResDto>>> getAssetList(@RequestParam(required = false)AssetLevelType assetLevel, @RequestParam(required = false)String category){
